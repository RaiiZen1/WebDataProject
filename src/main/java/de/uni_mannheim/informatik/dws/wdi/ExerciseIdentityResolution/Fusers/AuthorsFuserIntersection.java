...
public class AuthorsFuserIntersection extends AttributeValueFuser<List<String>, Book_DF, Attribute>{
    ...
    public void fuse(RecordGroup<Book_DF, Attribute> group, Book_DF fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
        ...
        fusedRecord.setAttributeProvenance(Book_DF.AUTHORS, fused.getOriginalIds());
    }
}
