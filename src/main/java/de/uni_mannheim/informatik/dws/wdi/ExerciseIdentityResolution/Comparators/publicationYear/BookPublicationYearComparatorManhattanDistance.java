...
public class BookPublicationYearComparatorManhattanDistance implements Comparator<Book, Attribute> {
	...
	public double compare(
        ...
        int yearDifference = Math.abs(year1.getYear() - year2.getYear());
