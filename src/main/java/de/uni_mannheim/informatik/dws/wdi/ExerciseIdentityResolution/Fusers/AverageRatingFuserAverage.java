...
public class AverageRatingFuserAverage extends AttributeValueFuser<Double, Book_DF, Attribute>{

    public AverageRatingFuserAverage() {
        super(new Average<Book_DF, Attribute>());
    }
