...
public class PublicationDateFuserMostRecent extends AttributeValueFuser<LocalDateTime, Book_DF, Attribute>{
    
    public PublicationDateFuserMostRecent() {
        super(new MostRecent<LocalDateTime, Book_DF, Attribute>());
    }
